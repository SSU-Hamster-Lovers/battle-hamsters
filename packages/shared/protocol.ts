...
import type { MatchSnapshot, PlayerSnapshot } from './world'
...
export type PlayerInputMessage = ProtocolEnvelope<'player_input', PlayerInputPayload>
...
export type WorldSnapshotMessage = ProtocolEnvelope<'world_snapshot', WorldSnapshotPayload>
export type PlayerJoinedMessage = ProtocolEnvelope<'player_joined', PlayerJoinedPayload>
export type PlayerLeftMessage = ProtocolEnvelope<'player_left', PlayerLeftPayload>
