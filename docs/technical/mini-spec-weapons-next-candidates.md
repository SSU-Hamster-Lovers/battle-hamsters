...
## ~~후보 A — 블루베리 박격포 (`blueberry_mortar`)~~ ✅ feat/blueberry-mortar-v1 완료
...
## ~~후보 B — 다람쥐 기관총 (`squirrel_gatling`)~~ ✅ feat/squirrel-gatling-v1 완료
...
| 2차: **후보 B** (다람쥐 기관총) | ✅ 완료 | auto fireMode는 중간 복잡도, 게임플레이 다양성 큰 폭 향상 |
| 3차: **후보 A** (블루베리 박격포) | ✅ 완료 | explode 시스템 신규 구현, 가장 복잡하지만 가장 임팩트 있음 |
