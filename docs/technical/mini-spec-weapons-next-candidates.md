...
| 우선순위 | 이유 |
|----------|------|
| 1차: **후보 C** (솔방울 저격총) | 신규 서버 로직 없음, 빠르게 무기 종수 확보 가능 |
| 2차: **후보 B** (다람쥐 기관총) | auto fireMode는 중간 복잡도, 게임플레이 다양성 큰 폭 향상 |
| 3차: **후보 A** (블루베리 박격포) | explode 시스템 신규 구현, 가장 복잡하지만 가장 임팩트 있음 |
