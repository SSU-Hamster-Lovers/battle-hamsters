...
mod game_data;
use game_data::{
    ground_top_y, item_definition, pit_left_x, pit_right_x, primary_fall_zone, room_id,
    runtime_map_data, weapon_definition, world_height, world_width, HazardKind, ItemType,
    RuntimeItemSpawnPoint, RuntimeWeaponSpawnPoint,
};
